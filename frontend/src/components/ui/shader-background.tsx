  ...
  return (
    <>
      <div
        aria-hidden
        className={cn(
          "pointer-events-none fixed inset-0 -z-10 bg-gradient-to-br from-[#1a1a4d] to-[#4d1a80] motion-safe:hidden",
          className,
        )}
      />
      <canvas
        ...
        aria-hidden
        className={cn(
          "pointer-events-none fixed inset-0 -z-10 h-full w-full motion-reduce:hidden",
          className,
        )}
      />
    </>
